...
{{#if line.fulfilled_qty}}
	<p>{{translate '<span class="transaction-line-views-quantity-amount-label">Fulfilled Quantity: </span> <span class="transaction-line-views-quantity-amount-value">$(0)</span>' line.fulfilled_qty }}</p>
{{/if}}
