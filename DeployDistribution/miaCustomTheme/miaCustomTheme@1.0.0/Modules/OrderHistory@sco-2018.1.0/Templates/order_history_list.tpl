...
<section class="order-history-list">
	...
	<div class="order-history-list-header-nav">
		<div class="order-history-list-header-button-group">
			...
			{{/if}}
			{{#if billedIsActive}}
			<span class="order-history-list-header-button-open-active">{{translate 'Billed'}}</span>
			{{else}}
			<a href="/billed-purchases" class="order-history-list-header-button-open">{{translate 'Billed'}}</a>
			{{/if}}
