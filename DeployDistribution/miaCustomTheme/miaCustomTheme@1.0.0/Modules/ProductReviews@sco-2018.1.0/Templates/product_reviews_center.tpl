	...
	<div class="product-reviews-center-more-info-content-container" data-action="pushable" data-id="product-reviews-center-review">
        <div class="product-reviews-center">
                ...
                <div class="product-reviews-center-container">
                    <div class="container">
                        <div class="product-reviews-center-container-header">
                            <h2 class="product-reviews-center-container-header-title">{{translate 'Reviews'}}</h2>
            ...
            {{else}}
                <div class="product-reviews-center-container">
                    <div class="product-reviews-center-container-header">
                        <h3 class="product-reviews-center-container-header-title">{{translate 'Reviews'}}</h3>
                        <h4 class="product-reviews-center-container-header-title">{{translate 'There are no reviews yet.'}}</h4>
                        <p>{{translate 'Be the first to review'}} <a href="{{itemUrl}}/newReview" class="product-reviews-center-container-button">{{translate 'Write a Review'}}</a></p>
                    </div>
                </div>
            {{/if}}
        </div>
