{{#unless hideContent}}
	<div class="requestquote-wizard-module-comments">
		<div class="requestquote-wizard-module-comments-box">
			...
			{{else}}
				<p>
					<label>{{#if isOpportunity}} {{translate 'Do you have any remarks or comments with this opportunity request?'}} {{else}}{{translate 'Do you have any remarks or comments with this quote request?'}}{{/if}}</label>
