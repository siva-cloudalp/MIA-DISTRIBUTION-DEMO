		...
		{{#unless showInModal}}
			<header>
				<h2 class="invoice-details-invoice-title">
				 	{{translate 'Cash Sale <span class="invoice-details-invoice-number">#$(0)</span>' model.tranid}}
			...
			<div class="invoice-details-header-row">
				<div class="invoice-details-header-col-left">
					...
					<p class="invoice-details-header-date-info">
						<span class="invoice-details-header-tranid-label">{{translate 'Cash Sale: '}}</span>
						<span class="invoice-details-header-tranid-value">{{model.tranid}}</span>
					</p>
					{{/if}}
					<p class="invoice-details-header-date-info">
						<span class="invoice-details-header-date-label">{{translate 'Cash Sale Date: '}}</span>
