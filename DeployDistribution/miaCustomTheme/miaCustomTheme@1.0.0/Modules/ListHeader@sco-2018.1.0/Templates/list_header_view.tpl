		...
		<div class="list-header-view-accordion" data-action="accordion-header">
			...
			<div class="list-header-view-accordion-body {{initiallyCollapsed}}" data-type="accordion-body" {{{accordionStyle}}}>
				<div class="list-header-view-accordion-body-header {{classes}}">
					...
					{{/if}}
					{{#if showSearchPO}}
						<label class="list-header-view-filters po_filter">
							<input type="text" name="filter_by_po" class="list-header-view-accordion-body-select" value="{{searchPO}}" placeholder="Search by PO#"/><i></i><div name="filter_by_po_reset">×</div>
						</label>
					{{/if}}
				</div>
			</div>
