...
{{#if showFacet}}
    ...
    <!--
		{{#if showHeading}}
			{{#if isUncollapsible}}
				<div class="facets-faceted-navigation-item-range-facet-group-expander {{#if isCollapsed}} collapsed {{/if}}">
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-range-facet-group-expander {{#if isCollapsed}} collapsed {{/if}}" data-toggle="collapse" data-target="#{{htmlId}} .facets-faceted-navigation-item-range-facet-group-wrapper" data-type="collapse" title="{{facetDisplayName}}">
