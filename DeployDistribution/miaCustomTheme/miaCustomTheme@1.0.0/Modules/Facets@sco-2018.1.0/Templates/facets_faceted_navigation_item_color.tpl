...
{{#if showFacet}}
	<div class="facets-faceted-navigation-item-color-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		{{#if showHeading}}
			{{#if isUncollapsible}}
				<div class="facets-faceted-navigation-item-color-facet-group-expander {{#if isCollapsed}} collapsed {{/if}}">
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-color-facet-group-expander {{#if isCollapsed}} collapsed {{/if}}" data-toggle="collapse" data-target="#{{htmlId}} .facets-faceted-navigation-item-color-facet-group-wrapper" data-type="collapse" title="{{facetDisplayName}}">
					<i class="facets-faceted-navigation-item-color-facet-group-expander-icon"></i>
