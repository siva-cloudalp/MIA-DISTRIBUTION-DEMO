<section class="overview-home">
	{{#with marketingBanners}}
	        {{#if has_main_banner_item}}
		<a data-hashtag="/product/{{main_banner_item}}" data-touchpoint="home" target="_blank" class="marketing-banners"><img src="{{main_banner}}"/></a>
		{{else}}
		<a href="{{main_banner_url}}"  target="_blank" class="marketing-banners"><img src="{{main_banner}}"/></a>	
		{{/if}}
	{{/with}}
