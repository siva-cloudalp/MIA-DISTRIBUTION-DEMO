...
import ProductDetailsQuantityView = require('../../../Advanced/ProductDetails/JavaScript/ProductDetails.Quantity.View');
import ProductDetailsImageGalleryView = require('../../../Advanced/ProductDetails/JavaScript/ProductDetails.ImageGallery.View');
...
const ProductDetailsBaseView: any = BackboneView.extend(
    {
        ...
        updateURL: function updateURL() {
            Backbone.history.navigate(encodeURI(this.model.generateURL()), { replace: true });
        },
