    ...
    <div class="become-a-partner-container-content-top">
        <div class="become-a-partner-top-content-row">
	        <div class="become-a-partner-text-top-content">
			    <h2 class="have-a-question-content">{{translate 'Have any Questions?'}}</h2>
				<h1 class="heading-chat-to-head-content">{{translate 'Chat to our Customer Success Team'}}</h1>
                
				<p class="content-p-component">{{translate 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in'}}</p>
