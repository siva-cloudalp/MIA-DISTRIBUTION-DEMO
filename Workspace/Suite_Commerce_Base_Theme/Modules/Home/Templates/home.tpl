...
----}}
<div class="home">
   <div class="home-cms-content-1">
   <div data-cms-area="home_cms_main_content-top-content" data-cms-area-filters="path"></div>
   <div>
    <div class="home-cms-content-2">
               ...
               <div class="col-sm-12 form-content">
                 <form method="POST" class="form-home-page">
                   ...
                   <!--<div class="submit-button-content">-->
                     <div class="submit-button-content">
                       <a class="submit-home-button" data-action="submitcontent">Submit</a>
                     </div>
                     <div class="signup-button-content">
                       <a class="signup-home-button" data-touchpoint="login" data-hashtag="login-register">SignUp/Login</a>
                     </div>
                   <!--</div>-->
                 </form>
    ...
    <div>
   <div class="home-cms-content-3">
    <div data-cms-area="home_cms_main_content-bottom-content" data-cms-area-filters="path"></div>
   <div>
</div>
{{!----
----}}
