...
<ul class="header-menu-myaccount">
	...
	<li class="header-menu-myaccount-overview">
		...
		<a class="header-menu-myaccount-signout-link" {{#if logoutUrl}} href="{{logoutUrl}}" data-navigation="ignore-click" {{else}}href="#" data-touchpoint="logout"{{/if}} name="signout">
	...
	<li class="header-menu-myaccount-item-level2">
		...
		<ul class="header-menu-myaccount-level3">
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#cashsales" data-permissions="transactions.tranCashSale.1" name="cash sales">{{translate 'Cash Sales'}}</a>
			</li>
			<li>
