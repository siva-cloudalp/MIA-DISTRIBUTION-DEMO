...
{{/unless}}
{{#if CartSidebar}}<div class="facet-cart-sidebar-header">Cart</div>{{/if}}
<div class="header-mini-cart{{#if CartSidebar}} facet-cart-sidebar{{/if}}">
	 {{#if showLines}}
	 	<div data-view="Header.MiniCartItemCell" class="header-mini-cart-container"></div>
		<div class="header-mini-cart-subtotal">

			{{#if isPriceEnabled}}
				{{translate '<b>Subtotal:</b> $(0)' subtotalFormatted}}
			{{/if}}
		</div>
