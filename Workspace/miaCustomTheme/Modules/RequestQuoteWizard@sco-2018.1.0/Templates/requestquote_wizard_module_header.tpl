<div class="requestquote-wizard-module-header">
	<h1 class="requestquote-wizard-module-header-title">
		{{#if isOpportunity}} {{translate 'Request an Opportunity'}} {{else}}{{translate 'Request a Quote'}}{{/if}}
	...
	<button class="requestquote-wizard-module-header-title-button" data-action="submit-step">
		{{#if isOpportunity}} {{translate 'Submit Opportunity Request'}} {{else}}{{translate 'Submit Quote Request'}}{{/if}}
	</button>
</div>
