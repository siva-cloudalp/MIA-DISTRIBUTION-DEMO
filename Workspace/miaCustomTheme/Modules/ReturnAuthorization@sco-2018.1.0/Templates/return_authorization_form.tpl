...
<section class="return-authorization-form">
	...
	{{#if hasKitItems}}
		<p class="return-authorization-form-kit-item-note">
		This order #{{model.tranid}} cannot be returned online, as it contains a kit item, <br/>Please reach out to support using the link <a href="/newcase">create a case</a>
		</p>
	{{else}}
