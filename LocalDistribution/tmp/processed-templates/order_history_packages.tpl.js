define('order_history_packages.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "				<div class=\"order-history-packages-header-container\">\n					<div class=\"order-history-packages-header-container-left\">\n"
    ...
    + ((stack1 = compilerNameLookup(helpers,"if").call(alias1,(depth0 != null ? compilerNameLookup(depth0,"showDeliveryMethod") : depth0),{"name":"if","hash":{},"fn":container.program(20, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":53,"column":6},"end":{"line":59,"column":13}}})) != null ? stack1 : "")
    + "					</div>\n				</div>\n";
  ...
  return "							<div class=\"order-history-packages-header-col"
    ...
    + "</span>\n								\n								<a class=\"order-history-packages-delivery-value\" target=\"_blank\" href=\""
    + alias3(((helper = (helper = compilerNameLookup(helpers,"shipMethodUrl") || (depth0 != null ? compilerNameLookup(depth0,"shipMethodUrl") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"shipMethodUrl","hash":{},"data":data,"loc":{"start":{"line":57,"column":79},"end":{"line":57,"column":96}}}) : helper)))
    + "\">"
    + alias3(((helper = (helper = compilerNameLookup(helpers,"deliveryMethodName") || (depth0 != null ? compilerNameLookup(depth0,"deliveryMethodName") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"deliveryMethodName","hash":{},"data":data,"loc":{"start":{"line":57,"column":98},"end":{"line":57,"column":120}}}) : helper)))
    + "</a>\n							</div>\n";
  ...
  return "<div class=\"order-history-packages-acordion-divider\">\n	<div class=\"order-history-packages-accordion-head\">\n		<div class=\"order-history-packages-accordion-head-toggle "
    ...
    + ((stack1 = compilerNameLookup(helpers,"unless").call(alias1,(depth0 != null ? compilerNameLookup(depth0,"isPackageInStore") : depth0),{"name":"unless","hash":{},"fn":container.program(15, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":35,"column":3},"end":{"line":62,"column":14}}})) != null ? stack1 : "")
    + "			<div class=\"order-history-packages-items-quantity\">"
    + alias4((compilerNameLookup(helpers,"translate")||(depth0 && compilerNameLookup(depth0,"translate"))||alias2).call(alias1,"$(0) Items",(depth0 != null ? compilerNameLookup(depth0,"linesItemsAmount") : depth0),{"name":"translate","hash":{},"data":data,"loc":{"start":{"line":63,"column":54},"end":{"line":63,"column":97}}}))
    + "</div>\n		</div>\n	</div>\n	<div class=\"order-history-packages-accordion-body collapse "
    + alias4(((helper = (helper = compilerNameLookup(helpers,"initiallyCollapsed") || (depth0 != null ? compilerNameLookup(depth0,"initiallyCollapsed") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"initiallyCollapsed","hash":{},"data":data,"loc":{"start":{"line":66,"column":60},"end":{"line":66,"column":82}}}) : helper)))
    + "\" id=\""
    + alias4(((helper = (helper = compilerNameLookup(helpers,"targetId") || (depth0 != null ? compilerNameLookup(depth0,"targetId") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"targetId","hash":{},"data":data,"loc":{"start":{"line":66,"column":88},"end":{"line":66,"column":100}}}) : helper)))
    + "\" role=\"tabpanel\" data-target=\"#"
    + alias4(((helper = (helper = compilerNameLookup(helpers,"targetId") || (depth0 != null ? compilerNameLookup(depth0,"targetId") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"targetId","hash":{},"data":data,"loc":{"start":{"line":66,"column":132},"end":{"line":66,"column":144}}}) : helper)))
...
},"useData":true}; var main = t.main; t.main = function(){ arguments[1] = arguments[1] || {}; var ctx = arguments[1]; ctx._extension_path = 'http://localhost:7777/tmp/extensions/miaCustomTheme/miaCustomTheme/1.0.0/'; ctx._theme_path = 'http://localhost:7777/tmp/extensions/miaCustomTheme/miaCustomTheme/1.0.0/'; return main.apply(this, arguments); }; var template = Handlebars.template(t); template.Name = 'order_history_packages'; return template;});